...
IF EXIST "%localAppData%\NVIDIA\DXCache\*" >nul 2>&1 RD /S /Q "%localAppData%\NVIDIA\DXCache"&&(ECHO nVidia system shader folder successfully cleared...>>"%logFile%")||(ECHO Error clearing nVidia system shader folder...>>"%logFile%")
